...
const Navbar = () => {
    ...
    return (
	<div className="border-b-2 shadow-md sticky top-0 bg-white">
		...
		<div className="flex flex-row items-center justify-between space-x-3">
			...
			height={20}
		    />
		    <div className="flex flex-row space-x-2 text-white items-center bg-tropical-blue-400 p-3 px-4 rounded-2xl cursor-pointer">
			<TfiMenuAlt size={20}/>	
